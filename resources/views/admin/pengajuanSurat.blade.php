...
@section('header', 'Buat Surat Pengajuan')
@section('content')
<div class="row">
            ...
            <form action="#" method="get" id="select">
                <div class="input-group shadow">
                    ...
                    <select name="jenisSurat" class="form-control">
                        ...
                        <option value="{{ route('suratkelahiranAdmin') }}">Surat Pengantar Kelahiran</option>
                        <option value="{{ route('suratkematian') }}">Surat Pengantar Kematian</option>
                    </select>
                </div>
